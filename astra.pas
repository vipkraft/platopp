          ...
          Setlength(mas_bil2,0,0);
               ...
               begin
                    ...
                    begin
                         ...
                         //stoim3
                         mas_bil2[n,4]:=Floattostrf(strtofloat(mas_bil2[n,4])+strtofloat(mas_bil[m,4]),fffixed,15,2);
                         //d
                         ...
                         //s
                         mas_bil2[n,8]:=Floattostrf(strtofloat(mas_bil2[n,8])+strtofloat(mas_bil[m,8]),fffixed,15,2);
                         //d
                         ...
                         //s
                         mas_bil2[n,12]:=Floattostrf(strtofloat(mas_bil2[n,12])+strtofloat(mas_bil[m,12]),fffixed,15,2);
                         //d
